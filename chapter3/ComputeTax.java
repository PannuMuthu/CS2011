...
public class ComputeTax {
	public static void main(String[] args) {
		...
		System.out.println("This program by Pratyush Muthukumar in the CS 2011-05 class will compute your taxes. Just input your filing status and your taxable income ");
		...
		if (status == 0) { // Compute tax for single filers if (income <= 8350)
			if (income <= 8350) 
				tax = income * 0.10;
		...
		else if (status == 1) { //Compute tax for married filed jointly or qualified widow(er)
			if (income <= 16700) 
				tax = income * 0.10;
